...
class StandardCustomEnumSpec extends Specification {
  ...
  def e1 = {
    ...
    val gen = new Generator(
      ...
      Map("example.idl" -> "example.idl.java", "other.ns" -> "other.ns.java")
    )
  ...
  def e3 = {
    ...
    val gen = new Generator(
      ...
      Map("example.idl" -> "example.idl.case", "other.ns" -> "other.ns.case")
    )
  ...
  def e5 = {
    ...
    val gen = new Generator(
      ...
      Map("example.idl" -> "example.idl.string", "other.ns" -> "other.ns.string")
    )
