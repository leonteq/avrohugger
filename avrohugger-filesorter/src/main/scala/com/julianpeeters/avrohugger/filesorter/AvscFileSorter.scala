...
/** The order in which avsc files are compiled depends on the underlying file system (under OSX its is alphabetical, under some linux
  ...
  * are compiled in the correct order. Code adapted from
  * https://github.com/ch4mpy/sbt-avro/blob/master/src/main/scala/com/c4soft/sbtavro/SbtAvro.scala by Jerome Wascongne
  */
